...
Winum is the successor of winumber-numbering.el which is no longer maintained and
therefore not supported by spaceline. Users of window-numbering.el are encouraged
to make the switch to winum.
